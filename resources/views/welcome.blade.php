...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <div class="flex items-center justify-center transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex w-[500px] flex-col-reverse lg:max-w-7xl lg:flex-row">

            <div class="flex flex-col items-center justify-center bg-gray-50 dark:bg-[#1C1C1A] text-center p-6 lg:w-[700px] rounded-tr-lg rounded-tl-lg lg:rounded-tr-none lg:rounded-br-lg shadow">
                <img src="{{asset('logo/vertical.png')}}" alt="Logo" class="w-75 h-75 mb-4 px-5" />

                <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">Welcome to FeedbackNest</h2>
                <p class="text-sm text-gray-600 dark:text-gray-300 mb-6">Share your thoughts, shape better ideas.</p>
                ...
                <div class="flex items-center justify-end gap-4">
                    ...
                    <a
                        href="{{ route('register') }}"
                        class="inline-block px-5 py-1.5 border-ebonyclay hover:border-lavendergray border text-ebonyclay rounded-sm text-sm leading-normal">
                        Register
                    </a>
                    @endif
                    @endauth
